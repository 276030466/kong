...
function Plugins:check_db_against_config(loaded_plugins)
  local in_db_plugins = {}
  ...
  for plugin in pairs(in_db_plugins) do
    if not loaded_plugins[plugin] then
...
function Plugins:load_plugin_schemas(loaded_plugins)
  local plugin_list = {}

  -- load installed plugins
  for plugin in pairs(loaded_plugins) do
